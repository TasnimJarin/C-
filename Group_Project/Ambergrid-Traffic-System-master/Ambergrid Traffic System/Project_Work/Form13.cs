    ...
    public partial class Form13 : Form
    {
                    ...
                    if (textBox3.Text.ToString().Length == 11 && ISNUMERIC(textBox3.Text))
                    {
                        ...
                        else
                        {
                            ...
                            if (a > 0 && b > 0)
                            {
                                BindGridView();
                                ResetContro();
                                MessageBox.Show("Sergeant Added", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                            else
                            {
                                MessageBox.Show("Add Sergeant Failed", "Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                ResetContro();
                            }
                            con.Close();
                        }
...

                {
                    ...
                    else
                    {
                        ...
                        if (a > 0 && b > 0)
                        {
                            BindGridView();
                            ResetContro();
                            MessageBox.Show("Sergeant Updated", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                        else
                        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (a > 0 && b > 0)
            {
                BindGridView();
                ResetContro();
                MessageBox.Show("Sergeant Removed", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
